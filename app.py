...
class ChatSocketHandler(tornado.websocket.WebSocketHandler):
    ...
    def open(self, room='root'):
        ...
        if room != 'main' and room != 'rooms':            
            message = {
                '_id': ''.join(random.choice(string.ascii_uppercase) for i in range(12)),
                'from': 'Bot',
                'body': self.application.usernames[self.get_secure_cookie('user')] + ' went to ' + room,
            }            
            ...
            try:
                ...
                self.application.client.rpush('rooms', message_encoded)
                # Publish message in Redis channel.
                self.application.client.publish('rooms', message_encoded)
...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        ...
        settings = dict(
            ...
            apptitle = 'Chat example: Tornado, Redis',
        )
